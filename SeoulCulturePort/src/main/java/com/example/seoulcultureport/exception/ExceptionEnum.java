...
public enum ExceptionEnum {
    ...
    TOKEN_ERROR(HttpStatus.BAD_REQUEST, "Token Error"), //400
    ...
    NOT_FOUND_POST_ADMIN(HttpStatus.NOT_FOUND, "게시물을 찾을 수 없습니다. (관리자 계정)"),
    NOT_FOUND_COMMENT_ALL(HttpStatus.NOT_FOUND, "댓글이 없습니다."),
    NOT_FOUND_COMMENT(HttpStatus.FORBIDDEN, "댓글 수정 권한이 없습니다."),
    NOT_FOUND_COMMENT_ADMIN(HttpStatus.NOT_FOUND, "댓글을 찾을 수 없습니다. (관리자 계정)"),
